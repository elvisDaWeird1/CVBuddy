...
'w-full appearance-none rounded-lg border bg-white px-3 py-2 pr-9 text-sm text-[var(--color-primary-dark)] ' +
...
{label && (
<label htmlFor={selectId} className="block text-sm font-medium text-[var(--color-primary-dark)] mb-1.5">{label}</label>
)}
