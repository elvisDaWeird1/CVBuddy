...
'w-full rounded-lg border bg-white px-3 py-2 text-sm text-[var(--color-primary-dark)] placeholder:text-[var(--color-gray-400)] ' +
...
{label && (
<label htmlFor={inputId} className="block text-sm font-medium text-[var(--color-primary-dark)] mb-1.5">
{label}
</label>
)}
