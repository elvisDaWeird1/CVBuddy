...
```
Đọc file PROJECT_CONTEXT.md trong thư mục D:\exe\frontend trước khi làm bất kỳ việc gì. Đảm bảo bạn hiểu rõ: cấu trúc dự án, design system đang dùng, component library hiện có, và các quy tắc trong phần "Rules for Future AI Work". Sau khi đọc xong, hãy thực hiện yêu cầu của tôi.
```
